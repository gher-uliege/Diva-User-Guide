...
\begin{enumerate}
 \item Copy the whole DIVA directory to your home directory on the cluster.
 \item Recompile the sources with \command{divacompileall}.
 \item Create symbolic links towards the scratch for input and output directories (to save disk space).
