...
\DeclareGraphicsExtensions{.jpg,.JPG,.png,.PNG,.ps,.eps}
\graphicspath{
...
{./figures/errors/},{./figures/advection/}
} 
...
\newcommand{\nablab}{\boldsymbol{\nabla}}
% \newcommand{\filefordivas}[1]{\href{run:../divastripped/#1}{\texttt{#1}}}
...
pdfmenubar=true,
pdfwindowui=true,
pdfauthor={Charles Troupin, M. Ouberdous, J.-M. Beckers},
