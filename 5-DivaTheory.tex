...
Minimization of (\ref{divaformula}) is actually performed by a Finite-Element (FE) method\index{Finite-element}, hence the need for generating a finite-element grid. 
