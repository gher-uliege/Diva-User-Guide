...
Relatively large number of data points in each plane penalizes Optimal Interpolation (OI) methods, because these methods require the inversion of a $N_{d}\timesN_{d}$ matrix (see Tab.~\ref{tabdata} and eq. \ref{eq:theory_error}).
