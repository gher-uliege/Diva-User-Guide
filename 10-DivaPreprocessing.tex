...
Basically, the procedure consists in changing the format of a topography file and making it readable by \diva. The methods presented in this Section correspond to different data bases of topography. 
...
This DBDB-B topography is not available any more, hence the method described below cannot be used. It is kept in this manual for archival purposes.
