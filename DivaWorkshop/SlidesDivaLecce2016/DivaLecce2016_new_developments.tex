...
$\rightarrow$ also quicker in ODV \includegraphics[height=.5cm]{odvico}
\end{center}
}
...
\includegraphics[height=.6cm]{Matlab_Logo}~\raisebox{0.2cm}{$\boldsymbol{\rightarrow}$}~\includegraphics[height=.6cm]{pythonlogo}
