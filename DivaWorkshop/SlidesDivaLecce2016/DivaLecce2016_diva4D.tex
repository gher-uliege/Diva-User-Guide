...
\huge
See Tutorial on installation or User Guide \url{http://modb.oce.ulg.ac.be/mediawiki/index.php/Diva_documents} %\href{run:./DivaWorkshop2015_installation.pdf}{\important{(pdf)}}
