...
{\bf Note:} the files without any depth axis are treated separately by the \command{divano\-depthODV4}. This script also handles the current direction (CurrDir [deg T]) and speed (CurrSpd [cm/s]) and transforms them into x-y components (North, East). 
