...
\begin{itemize}
\item {\bf Data extraction}: Possible flag values: $0$,$1$,$2$,$-1$ and $-10$. If you activate the data extraction (flag value $\neq 0$)
...
\begin{enumerate}
 ...
 \item Edit divacutNCDF : the first lines (USER SETTINGS) allow you to define the original 4D netcdf file, the contour file 
