...
They must be ODV SeaDataNet compliant: \url{https://www.bodc.ac.uk/data/codes\_and\_formats/odv\_format/}.

\textbf{IMPORTANT :} Time series are now allowed, but have to be placed in a different ODV file than profiles. The time 
axis used for time series is "time\_ISO8601". For profiles, the time axis is labelled "yyyy-mm(-ddThh:mm:ss.sss)".
