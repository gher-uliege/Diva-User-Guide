...
\begin{figure}[htpb]
\centering
\includegraphics[width=.495\textwidth,viewport=51 235 560 556]{data_blacksea_python}\includegraphics[width=.495\textwidth,viewport=51 235 560 556]{mesh_blacksea_python}
