...
List of all \command{diva*} with small description of action associated and classification (pre-propessing, parameter optimisation, etc)
Note that \commands{dv*} are normally not to be used directly by users but are exploited by the main \diva scripts \command{diva*}.
